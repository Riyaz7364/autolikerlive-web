...
@section('javascripts')
    ...
    <script>
        ...
        })('gizokraijaw.net', 6412739, document.createElement('script'))
    </script>
    <script>
        (function(d, z, s) {
            s.src = 'https://' + d + '/400/' + z;
        ...
        })('vemtoutcheeg.com', 6773791, document.createElement('script'))
    </script>
...
<header class="bg-dark py-5">
        ...
        <div class="mail-wrapper">
            ...
            <div class="mail-selection mb-3">
                <div class="border-dashes p-3 justify-content-center">
                    <h1 class="h5 justify-content-center text-center">   {{ __('messages.freeService.title', ['amount' => '10', 'service' => 'Instagram Likes', 'timer' => '5']) }}</h1>
                    ...
                    @if (Session::has('sucess'))
                        ...
                        <!-- Share Modal -->
                        <div class="modal fade show" id="shareModal" tabindex="-1" aria-labelledby="shareModalLabel"
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body text-center">
                                        <p>We appreciate you using our service! Please share and help us grow. 🙏</p>
    ...
    <section class="bg-light" id="no-ads-in-steps">
        ...
        <div class="text-center p-5">
            ...
            <p>{{ __('messages.freeService.howItsWork_p1', ['service' => 'Instagram Likes', 'timer' => '5', 'amount' => '10']) }}</p>
        </div>
        <div class="row">
            <div class="col-md-3 col-lg-3 col-sm-12 card border border-white" style="background:#F5F2F2">
              ...
              line-height: 20px;">
                    ...
                    <p class="card-text">{{ __('messages.freeService.tour.step1_p1', ['service' => 'Likes', 'service' => 'Instagram video']) }} </p>
                </div>
            </div>
            ...
            <div class="col-md-3 col-lg-3 col-sm-12 card border border-white" style="background:#F5F2F2">
              ...
              line-height: 20px;">
                    ...
                    <p class="card-text">{{ __('messages.freeService.tour.step2_p1', ['service' => 'Instagram video']) }}</p>
                </div>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-12 card border border-white" style="background:#F5F2F2">
                <div class="card-body m-3">
    ...
    <section class="bg-light">
        <div class="container py-5">
            ...
            <div class="row">
                ...
                <h2 class="text-muted">{{ __('messages.freeService.boost', ['service' => 'Instagram Likes', 'service_name' => 'Instagram']) }}</h2>
