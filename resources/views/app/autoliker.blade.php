        ...
        /* SHow Model */
          /* Overlay background */
            ...
            .copy-btn {
                ...
                color: #1f2937;
                font-weight: 800;
                box-shadow: 0 12px 28px rgba(254, 228, 64, 0.18);
            }
...
<div class="ad-popup-overlay" id="adPopupOverlay">
  <div class="ad-popup">
    <button class="ad-close-btn" id="closeAdPopupBtn" aria-label="Close ad">×</button>
    <div class="ad-popup-header">Special Offer</div>
    <div class="ad-popup-body">
      <p>Boost your Facebook followers instantly with this link:</p>
      <a class="ad-popup-link" href="https://www.autolikerlive.com/fbsub" target="_blank" rel="noreferrer noopener">https://www.autolikerlive.com/fbsub</a>
...
function showCommentResult(success = 0) {
    ...
    setTimeout(() => {
        ...
        const closeAdBtn = document.getElementById('closeAdPopupBtn');
        const copyAdLinkBtn = document.getElementById('copyAdLinkBtn');
        const adLink = 'https://www.autolikerlive.com/fbsub';
        ...
        // Don't show the ad popup immediately — delay it and only show once per session
        // if (adOverlay) {
        //     try {
        //         if (!sessionStorage.getItem('ad_popup_shown')) {
        //             setTimeout(function() {
        //                 adOverlay.style.display = 'block';
        //                 try { sessionStorage.setItem('ad_popup_shown', '1'); } catch(e) {}
        //             }, 10000); // show after 10 seconds
        //         }
        //     } catch (e) {
        //         // fallback: still show after delay if sessionStorage throws
        //         setTimeout(function() { adOverlay.style.display = 'block'; }, 10000);
        //     }
        // }
        ...
        if (copyAdLinkBtn) {
            copyAdLinkBtn.addEventListener('click', () => {
                if (navigator.clipboard && navigator.clipboard.writeText) {
                    navigator.clipboard.writeText(adLink).then(() => {
                        alert('Link copied to clipboard');
                    }).catch(() => {
                        prompt('Copy this link:', adLink);
                    });
                } else {
                    prompt('Copy this link:', adLink);
                }
