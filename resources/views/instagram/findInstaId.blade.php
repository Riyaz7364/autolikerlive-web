...
@section('title', 'Find Instagram User ID - Find Instagram ID by username')
@section('description',
    'Discover how to find any Instagram User ID by username with our easy-to-follow guide. Learn the
    steps to quickly locate Instagram IDs efficiently.')
    ...
    <main class="flex-shrink-0">
        <section class="bg-dark container">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 mt-5">
                    ...
                    <h1>Find Instagram User ID</h1>
                    <p class="lead">
                        Easily view Instagram User ID bt username with our find my INSTA ID tool. Enter a
                        <code>username</code> to see Instagram user ID. Free and easy to use!
                        <br>
                        Enter your <b>Instagram profile username</b> below:
                    </p>
                    <form id="searchform">
                        @csrf
                        <div class="mb-3 flex items-center gap-2">
                            ...
                            <input name="username" type="text" placeholder="InstagramHandle"
                                class="border rounded px-3 py-2 flex-1">
                            <span class="px-2">{!! getIcon('instagram', 'insta') !!}</span>
                        </div>
                        <div class="g-recaptcha" data-sitekey="6LdsafIpAAAAAOgUpSrqpB785DTkN23zATU0qQ2M"></div>
                        <button type="submit" class="inline-flex items-center gap-2 bg-[var(--fb-blue)] text-white px-4 py-2 rounded-md mt-2">Search User ID →</button>
                    </form>
                    ...
                    <div class="card mb-3 d-none" id="result">
                        <div class="row g-0">
                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title text-dark" id="username">theriyazsaifi</h5>
                                    <p class="card-text text-dark">User ID: <code id="ds_user_id">11796325697</code></p>
                                    <p class="card-text text-dark">Followers: <code id="followers">149898</code> -
                                        Following:
                                        <code id="following">293</code>
                                    </p>
                                    <p class="card-text text-dark">Available pictures and videos: <code
                    ...
                    <h2>View Instagram user ID Easily</h2>
                    <p>
                        By default, Instagram does not allow you to view users numberic ID.
                        Our web tool offers a convenient way to view user ID. Simply enter the
                        profile username to see the profile ID for free. This tool works for public profiles,
                        allowing you to see amy user id.
                    </p>

                    <h2>Key Features:</h2>
                    <ul class="text-white">
                        <li>View Instagram user numberic ID</li>
                        <li>Simple and easy-to-use interface</li>
                        <li>Works with public and private profiles</li>
                    </ul>

                    <h2>Please Note:</h2>

                    <ul class="text-white">
                        <li>This tool only supports public and private profiles in accordance with Instagram’s terms of
                            service.</li>
                    ...
                    <div class="container">
                        ...
                        <ul class="examples good">
                            ...
                            <p>This tool allows you to view Instagram user id by username. By entering a public
                                profile username, you can see the user numberic ID by our<strong>find Instagram user
                                    ID</strong>.
                            </p>
                            <li><code>Can I view private account user id using this tool?</code></li>
                            <p>No, this tool only works with public profiles. It cannot access or display photos from
                                private profiles or profiles that have blocked you, in accordance with Instagram's terms of
                                service.</p>
                            <li><code>Is it legal to use this tool?</code></li>
                            <p>Yes, as long as you use it to view public profiles and respect Instagram's terms of service.
                            ...
                            <p>No, you do not need an Instagram account to use this tool. You simply need the URL of the
                                public profile you wish to view.</p>
                            <li><code>How do I find the username of an Instagram profile?</code></li>
                            <p>To find the URL of an Instagram profile username, go to the Instagram app or website,
                                navigate to the
                                profile you want to view, and copy the URL from the address bar (web) or the share option
                                (app).</p>
        ...
        <script>
            document.getElementById('searchform').addEventListener('submit', function(event) {
                ...
                axios.post('https://www.autolikerlive.com/downloader/instagram/get_avatar', formData, {
                        headers: {
