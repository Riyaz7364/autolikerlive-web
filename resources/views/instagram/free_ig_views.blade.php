...
@section('content')
    <main class="bg-light">
        <div class="container mt-5">
            <div class="row">
                <h1 class="text-center">Free IG Views</h1>
                    ...
                    <div class="mail-selection mb-3">
                        <div class="border-dashes p-3 justify-content-center">
                            ...
                            <form method="post" action="{{ route('free-tiktok-views-post') }}" id="form">
                                @csrf
                                <input type="hidden" name="type" value="INSTA_VIEWS">
                                @if ($errors->any())
                                ...
                                <div class="mb-3 flex gap-2 items-start">
                                    ...
                                    <div>
                                        <button class="inline-flex items-center gap-2 bg-[var(--fb-blue)] text-white px-4 py-2 rounded-md font-semibold" id="sendViewsBtn" type="submit">Send Views</button>
                                    </div>
                                </div>
            ...
            <section class="bg-light" id="no-ads-in-steps">
                ...
                <div class="text-center p-5">
                    ...
                    <p>{{ __('messages.freeService.howItsWork_p1', ['service' => 'Instagram Views', 'timer' => '10', 'amount' => '100']) }}
                    </p>
                </div>
                <div class="row">
                  ...
                  line-height: 10px;">
                            ...
                            <p class="card-text">
                                {{ __('messages.freeService.tour.step1_p1', ['service' => 'Views', 'service' => 'Instagram video']) }}
                            </p>
                        </div>
                    </div>
                  ...
                  font-weight: 700;
                  line-height: 10px;">
                                {{ __('messages.freeService.tour.step4', ['type' => 'Views']) }}</h6>
                            <p class="card-text">{{ __('messages.freeService.tour.step4_p1', ['type' => 'Views']) }}</p>
                        </div>
                    </div>
                ...
                <div class="row text-center p-5">
                    ...
                    <div class="col-md-4">
                        ...
                        <p>
                            {!! __('messages.freeService.ourServices_p1', ['service' => 'Instagram Views']) !!}
                        </p>
                    </div>
                </div>
            </section>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            try {
                ...
                const message = encodeURIComponent(
                    "Instagram Auto Views - Get Unlimited Free Instagram Views every 10 minutes 🚀🔥");
                const hashtags = encodeURIComponent("autolikerlive,freeInstaViews,freeViews");
