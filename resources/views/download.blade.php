                            ...
                            <div class="col-md-6">
                                <div class="contact-card p-4 text-center h-100">
                                    ...
                                    <a href="mailto:contact@autolikerlive.com"
                                        class="btn btn-modern btn-success text-white px-4 py-3">
                ...
                const initTimer = () => {
                    ...
                    const initCounter = setInterval(() => {
                        ...
                        downloadBtn.parentNode.innerHTML =
                            `Download not starting? <a href="{{ route('apk.download') }}" class="btn btn-success">Click here</a>`;
                        setTimeout(() => {
