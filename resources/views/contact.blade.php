                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            <form method="POST" action="{{ route('sendMessage') }}">
                                ...
                                <div class="w-full mt-3"><button id="submitButton" type="submit" class="w-full bg-[var(--fb-blue)] hover:bg-blue-700 text-white font-semibold py-3 rounded-lg">Send Message</button></div>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="#" class="inline-block border border-[rgba(24,119,242,0.12)] text-[var(--fb-blue)] px-4 py-2 rounded-md">Start Chat</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="mailto:support@autolikerlive.com" class="inline-block border border-[rgba(24,119,242,0.12)] text-[var(--fb-blue)] px-4 py-2 rounded-md">Send Email</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <div class="card-body text-center p-4">
                                ...
                                <a href="{{ route('faq') }}" class="inline-block border border-[rgba(24,119,242,0.12)] text-[var(--fb-blue)] px-4 py-2 rounded-md">View FAQ</a>
                            </div>
                        </div>
                    </div>
                </div>
