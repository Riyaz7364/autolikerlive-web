...
@php
    // Per-keyword title/description overrides for top-impression pages (GSC CTR rescue).
    $landingSeo = [
        'liker us' => [
            'title' => 'Liker Us - Free Facebook Auto Liker',
            'description' => 'Use Liker Us free auto liker to boost Facebook likes online. Fast, safe, no login required. Try the free Liker Us tool now.',
        ],
    ];
    $landingKey = strtolower(trim($keyword ?? ''));
