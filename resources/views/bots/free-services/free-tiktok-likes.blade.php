...
@section('description',
    'Get free TikTok likes from us and the user-friendly TikTok likes service we provide. We are the
            ...
            <div class="container pxc-5">
                ...
                <div class="row gx-5 align-items-center justify-content-center">
                    <div class="col">
                        <div class="row py-3 px-3 text-center">
                            <div class="col-12 pb-3">
                                {!! getIcon('tiktok', 'feature p-3 tiktokIcon') !!}
                                {!! getIcon('tiktok', 'feature p-3 tiktokIcon') !!}
                                {!! getIcon('tiktok', 'feature p-3 tiktokIcon') !!}
                                {!! getIcon('tiktok', 'feature p-3 tiktokIcon') !!}
                                {!! getIcon('tiktok', 'feature p-3 tiktokIcon') !!}
                    ...
                    <div class="col-md-10 col-lg-6 col-sm-12 pxc-5">
                        <h1 class="h5 text-center">Get 10 free TikTok likes every 15 minutes.</h1>
                        <div class="border-dashes p-3 justify-content-center">
                            <h2 class="text-center text-white justify-content-center p-3 h6">Boost Your
                                ...
                                Presence: Enjoy 10 Free Auto Likes Every 15 Minutes!
                            </h2>
