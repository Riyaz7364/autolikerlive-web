                ...
                <div class="col-sm-12 col-md-8 col-lg-8 mt-5">
                    ...
                    <div class="text-center">
                        <div class="p-2 text-center">
                            ...
                            @endif
                            @if (\Session::has('fail'))
                                <p class="h2">{!! __('messages.findmyfbid.input.error') !!}<a target="_blank" rel="nofollow nooper"
                                        href="https://www.facebook.com/settings/?tab=how_people_find_and_contact_you">Facebook
                                        Profile
                                        settings</a> </p>
                                <img class="w-100" src='https://i.postimg.cc/02ZXKPKk/Capture.png' border='0'
                                    alt='Do you want search engines outside of Facebook to link to your profile?' />
                            @endif
                        </div>
                    </div>
                    <section>
