...
@section('content')
    <div class="tiktok-header">
        ...
        <p>Get a free visibility boost for your TikTok videos.</p>
    </div>
    ...
    @else --}}
        <div class="tiktok-card">
            <a href="{{ route('autoliker.facebook') }}" class="facebook-btn btn btn-sm mb-3">FB Auto Liker 1000 likes</a>
            <form method="post" action="{{ route('free-tiktok-views-post') }}" id="form">
                ...
                <div class="col-12 text-center mb-2">
                    <button class="tiktok-btn" id="sendViewsBtn" type="submit">Request Views</button>
                </div>
                <div id="countdown" class="btn btn-outline-info btn-block mt-3" style="font-size:1.2rem;">Ready</div>
                <p class="text-center text-muted small mt-3">Results may vary and depend on current TikTok activity. This service is intended to help increase exposure responsibly.</p>
    ...
    <div class="tiktok-features">
        ...
        <div class="tiktok-feature-card">
            ...
            <h4>Free to Use</h4>
            <p>Use the service without any hidden fees; results depend on availability.</p>
        </div>
    </div>
    ...
    <script data-cfasync="false">
        ...
        const message = encodeURIComponent("TikTok Auto Views - Improve visibility for your TikTok videos with free boosts.");
        const hashtags = encodeURIComponent("autolikerlive,tiktokviews");
        ...
        // Set Share URLs only if the share buttons exist on the page
        safeSetHref("facebookShare", `https://www.facebook.com/sharer/sharer.php?u=${pageUrl}`);
        safeSetHref("twitterShare", `https://twitter.com/intent/tweet?url=${pageUrl}&text=${message}&hashtags=${hashtags}`);
        safeSetHref("whatsappShare", `https://api.whatsapp.com/send?text=${message} ${pageUrl}`);
        safeSetHref("telegramShare", `https://t.me/share/url?url=${pageUrl}&text=${message}`);
        safeSetHref("pinterestShare", `https://pinterest.com/pin/create/button/?url=${pageUrl}&media=${imageUrl}&description=${message}`);
