...
@section('title', 'Get Token Cookie Extension - Free Download')
...
@section('description',
    'Download Get Token Cookie extension free for Android. Manage multiple accounts and
    generate tokens effortlessly. Free download with easy setup guide.')
@section('javascripts')
    <style>
        .thumbnail {
            max-width: 11rem;
