...
class SitemapBuilder
{
    ...
    /**
     * Listing slugs that must never appear in the sitemap:
     * consolidated via 301 to a canonical page, or gone (410).
     */
    public static function excludedListingSlugs(): array
    {
        return [
            'facebook-auto-liker-2022',
            'facebook-auto-liker-2023',
            'facebook-autoliker',
            'ig-auto-liker',
