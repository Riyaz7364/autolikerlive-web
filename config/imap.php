...
return [
    ...
    */
    'accounts' => [
        'default' => [ // account identifier
            'host'  => env('TEMP_IMAP_HOST', 'localhost'),
            'port'  => env('TEMP_IMAP_PORT', 993),
            'protocol'  => env('TEMP_IMAP_PROTOCOL', 'imap'), //might also use imap, [pop3 or nntp (untested)]
            'encryption'    => env('TEMP_IMAP_ENCRYPTION', 'ssl'), // Supported: false, 'ssl', 'tls', 'notls', 'starttls'
            'validate_cert' => env('TEMP_IMAP_VALIDATE_CERT', true),
            'username' => env('TEMP_IMAP_USERNAME', 'root@example.com'),
            'password' => env('TEMP_IMAP_PASSWORD', ''),
            'authentication' => env('TEMP_IMAP_AUTHENTICATION', null),
            'proxy' => [
                'socket' => null,
    ...
    */
    'options' => [
        ...
        'fetch_body' => false,  // Changed to false for lazy-loading - bodies are fetched only when accessed
        'fetch_flags' => true,
        'soft_fail' => true,    // Changed to true to ignore errors during bulk message fetching
        'rfc822' => true,
        'debug' => false,
        'uid_cache' => true,
